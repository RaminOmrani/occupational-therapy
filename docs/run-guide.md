...
6. ورود: مدیر `09120000001` رمز `admin1234`. (منشی `09120000002`، درمانگر `09120000003` و `09120000004` با همان رمز؛ مراجع نمونه `09120000010` رمز `OT-00001`.)
...
5. داده‌های نمونه را می‌توانید نگه دارید یا مراجعین نمونه را بایگانی کنید.
