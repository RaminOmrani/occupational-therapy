...
| `SECRETARY` | برنامه‌ریزی و قطعی‌کردن روز، مراجعین، لیدها، مالی (صورت‌حساب/پرداخت/کیف پول/تخفیف)، پیامک، بازخوردها، مقالات؛ فرم‌های بالینی فقط خواندنی |
| `THERAPIST` | برنامه و مراجعین خود، ثبت/ویرایش فرم‌های بالینی خود، اهداف و تمرین خانگی، مقالات |
...
- **User** ← Therapist / Patient (اختیاری). مراجع می‌تواند بدون حساب کاربری هم باشد.
...
- **Feedback** (مراجع یا مهمان سایت)، **Article**، **SmsTemplate / SmsLog / SmsCampaign**، **Setting**، **Counter** (شماره‌گذاری)، **Notification**، **AuditLog**، **OtpCode**.
