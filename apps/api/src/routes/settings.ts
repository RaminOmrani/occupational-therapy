...
settingsRouter.get("/", async (_req, res) => {
  ...
  const groups: Record<string, string> = { clinic: "اطلاعات کلینیک", public: "سایت عمومی", schedule: "نوبت‌دهی", finance: "مالی", crm: "CRM", sms: "پیامک", booking: "نوبت‌دهی آنلاین", payment: "درگاه پرداخت", consent: "رضایت‌نامه", app: "اپلیکیشن", security: "امنیت و بکاپ", general: "عمومی" };
