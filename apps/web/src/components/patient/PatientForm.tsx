  ...
  return (
    <form onSubmit={submit} className="space-y-5">
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Field label="شماره موبایل" required hint="برای ورود مراجع به اپلیکیشن و دریافت پیامک"><Input value={v.phone} onChange={(e) => set("phone", e.target.value)} required dir="ltr" className="num text-left" placeholder="09123456789" /></Field>
        ...
        <Field label="شماره دوم (سرپرست)"><Input value={v.guardianPhone} onChange={(e) => set("guardianPhone", e.target.value)} dir="ltr" className="num text-left" /></Field>
