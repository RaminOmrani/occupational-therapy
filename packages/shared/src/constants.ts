...
export const DEFAULT_SETTINGS: Record<string, { value: string; group: string; label: string; description?: string; type: "text" | "number" | "boolean" | "json" | "password" | "textarea" | "select"; options?: string[]; secret?: boolean }> = {
  "clinic.name": { value: "کلینیک کاردرمانی ترنج", group: "clinic", label: "نام کلینیک", type: "text" },
  "clinic.tagline": { value: "همراه شما در مسیر استقلال و توانمندی", group: "clinic", label: "شعار کلینیک", type: "text" },
  "clinic.phone": { value: "021-00000000", group: "clinic", label: "تلفن کلینیک", type: "text" },
  "clinic.mobile": { value: "09120000000", group: "clinic", label: "موبایل / واتساپ", type: "text" },
  "clinic.address": { value: "تهران، ...", group: "clinic", label: "آدرس", type: "textarea" },
  ...
  "clinic.about": { value: "کلینیک کاردرمانی ترنج با تیمی از درمانگران مجرب، خدمات کاردرمانی جسمی، ذهنی و شناختی را برای کودکان و بزرگسالان ارائه می‌دهد.", group: "clinic", label: "درباره ما", type: "textarea" },
  ...
  "sms.signature": { value: "کلینیک کاردرمانی ترنج", group: "sms", label: "امضای انتهای پیامک‌ها", type: "text" },
  ...
  "public.heroTitle": { value: "بازگشت به زندگی، با مهارت و امید", group: "public", label: "عنوان اصلی صفحه نخست", type: "text" },
