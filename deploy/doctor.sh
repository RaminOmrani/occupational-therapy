...
echo "=== ports"; ss -ltnp 2>/dev/null | grep -E ":3000|:4000|:80 " || echo "no listeners"
echo "=== api health (direct)"; curl -s -m 5 http://127.0.0.1:4000/api/health || echo "API پاسخ نمی‌دهد"; echo
